...
// Function to show section by ID and hide others
...
// Policies link
document.querySelectorAll("[data-action='show-policy']").forEach(btn => {
  btn.addEventListener("click", () => {
    showSection("policySection");
  });
});

// Example: add more handlers if needed (orders, customers, etc.)
document.querySelectorAll("[data-action='show-orders']").forEach(btn => {
  btn.addEventListener("click", () => {
